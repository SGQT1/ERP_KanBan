...
{
    public partial class BatchProductionCostStandard
    {
        public BatchProductionCostStandard()
        {
            BatchMaterialCostStandard = new HashSet<BatchMaterialCostStandard>();
        }
        ...
        public virtual ICollection<BatchMaterialCostStandard> BatchMaterialCostStandard { get; set; }
    }
}
