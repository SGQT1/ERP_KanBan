...
{
    public partial class BatchProductionCostStuff
    {
        public BatchProductionCostStuff()
        {
            BatchMaterialCostStuff = new HashSet<BatchMaterialCostStuff>();
        }
        ...
        public virtual ICollection<BatchMaterialCostStuff> BatchMaterialCostStuff { get; set; }
    }
}
