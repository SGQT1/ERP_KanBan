...
{
    public partial class MpsProcedureVendor
    {
        public MpsProcedureVendor()
        {
            MpsProcedureVendorItem = new HashSet<MpsProcedureVendorItem>();
        }
        ...
        public virtual ICollection<MpsProcedureVendorItem> MpsProcedureVendorItem { get; set; }
    }
}
