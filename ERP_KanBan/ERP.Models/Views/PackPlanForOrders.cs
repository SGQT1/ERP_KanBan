...
namespace ERP.Models.Views
{
     ...
     * replace OrdersPL
     */
    public class PackPlanForOrders
    {
        public decimal Id { get; set; }
        public decimal LocaleId { get; set; }

        public decimal? RefPackPlanId { get; set; }
        public decimal? RefPackPlanLocaleId { get; set; }
        ...
        public int? HasPL { get; set; }
        public string InvoiceNo { get; set; }
        public string RefPOCode { get; set; }
        public string RefColorDesc { get; set; }
        public DateTime? RefOWD { get; set; }
        public DateTime? RefRSD { get; set; }
        public string RefSpecialDesc { get; set; }
        public string RefSpecialNote { get; set; }
        public string RefCustomerVendorCode { get; set; }
    }
}
