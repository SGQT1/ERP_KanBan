...
{
    public class MPSInspectLogSizeItemService : BusinessService
    {
        private Services.Entities.MpsReceivedLogSizeItemService MPSReceivedLogSizeItem { get; }

        public MPSInspectLogSizeItemService(
        ...
        public IQueryable<Models.Views.MPSInspectLogSizeItem> Get()
        {
            return MPSReceivedLogSizeItem.Get().Select(i => new Models.Views.MPSInspectLogSizeItem
            {
                Id = i.Id,
                LocaleId = i.LocaleId,
        ...
        public void CreateRange(IEnumerable<Models.Views.MPSInspectLogSizeItem> items)
        {
        ...
        private IEnumerable<ERP.Models.Entities.MpsReceivedLogSizeItem> BuildRange(IEnumerable<Models.Views.MPSInspectLogSizeItem> items)
        {
