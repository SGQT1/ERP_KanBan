...
{
    public class NBSCCReportService : BusinessService
    {
        ...
        public IQueryable<Models.Views.NBSCCReport> Get()
        {
            return NBSCCReport.Get().Select(i => new Models.Views.NBSCCReport
            {
                Id = i.Id,
                LocaleId = i.LocaleId,
                POItemId = i.POItemId,
        ...
        public void CreateRange(IEnumerable<Models.Views.NBSCCReport> items)
        {
            NBSCCReport.CreateRange(StockOutBuildRange(items));
        }
        public void RemoveRange(List<decimal> items)
        {
            NBSCCReport.RemoveRange(i => items.Contains(i.Id));
        }
        private IEnumerable<Models.Entities.NBSCCReport> StockOutBuildRange(IEnumerable<Models.Views.NBSCCReport> items)
        {
            return items.Select(item => new Models.Entities.NBSCCReport
            {
                Id = item.Id,
