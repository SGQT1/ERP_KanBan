...
{
    public class ReceivedLogSizeItemService : BusinessService
    {
        private Services.Entities.ReceivedLogSizeItemService ReceivedLogSizeItem { get; }
        
        private Services.Entities.StockIOSizeService MaterialStockItemSize { get; set; }

        public ReceivedLogSizeItemService(
            Services.Entities.ReceivedLogSizeItemService receivedLogSizeItemService,
            Services.Entities.StockIOSizeService materialStockItemSizeService,
            UnitOfWork unitOfWork
        ) : base(unitOfWork)
        {
            this.ReceivedLogSizeItem = receivedLogSizeItemService;
            this.MaterialStockItemSize = materialStockItemSizeService;
        }
        public IQueryable<Models.Views.ReceivedLogSizeItem> Get()
        {
            return ReceivedLogSizeItem.Get().Select(i => new Models.Views.ReceivedLogSizeItem
            {
                Id = i.Id,
                LocaleId = i.LocaleId,
        ...
        public void                                                                                                                                                                                                                                                     CreateRange(IEnumerable<Models.Views.ReceivedLogSizeItem> items)
        {
        ...
        private IEnumerable<ERP.Models.Entities.ReceivedLogSizeItem> BuildRange(IEnumerable<Models.Views.ReceivedLogSizeItem> items)
        {
