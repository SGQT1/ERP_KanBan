...
{
    public class BOMRepOrdersService : BusinessService
    {
        private Services.Entities.BOMRepOrdersService BOMRepOrders { get; }

        public BOMRepOrdersService(Services.Entities.BOMRepOrdersService bomRepOrdersService, UnitOfWork unitOfWork):base(unitOfWork)
        {
            this.BOMRepOrders = bomRepOrdersService;
        }
        public IQueryable<ERP.Models.Views.View.BOMOrders> Get()
        {
            return BOMRepOrders.Get().Select(i => new ERP.Models.Views.View.BOMOrders
            {
